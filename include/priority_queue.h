...
private:
    ...
    // костыль, т.к. реализовать передачу comp по аналогии с priority_queue не вышло
    Compare comp = [](std::pair<uint32_t, std::function<void()> *> left, std::pair<uint32_t, std::function<void()> *> right) {
